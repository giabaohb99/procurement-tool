...
/**
 * Hồ sơ nhân sự và liên hệ — CHỈ XEM.
 *
 * Cố ý không cho sửa tại đây: mã nhân viên, phòng ban và vai trò là dữ liệu
    ...
    <>
      <FormCard title="Hồ sơ nhân sự" icon={User} iconClassName="text-muted-foreground">
        ...
        <p className="mt-3 flex gap-2 rounded-lg bg-accent px-3 py-2 text-xs text-muted-foreground">
          ...
          <span>
            Hồ sơ nhân sự và vai trò do bộ phận Nhân sự / Quản trị hệ thống cập nhật. Nếu
            thông tin chưa đúng, hãy liên hệ bộ phận Nhân sự để được chỉnh sửa.
          </span>
        </p>
      </FormCard>

      <FormCard title="Liên hệ" icon={Mail} iconClassName="text-muted-foreground">
