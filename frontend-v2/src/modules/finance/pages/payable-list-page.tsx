 ...
 *  - v1 tải hết 1000 dòng rồi tự cắt trang ở trình duyệt; ở đây phân trang do
 *    server làm, nên năm nợ nhiều nghìn dòng không còn treo màn.
 *  - CỘT CHỌN + nút "Tạo yêu cầu thanh toán" TẠM CHƯA CÓ: màn Yêu cầu thanh
 *    toán chưa được dời sang v2 nên nút sẽ dẫn vào trang trống. Gắn lại ngay khi
 *    `payment-request` lên — chỗ tick chọn là toàn bộ lý do tồn tại của cột đó.
 */
