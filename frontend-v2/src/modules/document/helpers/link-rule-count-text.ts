 ...
 *
 * Nhận đúng HAI CỘT nó cần chứ không đòi cả bản ghi: dòng quy tắc còn đang xếp
 * hàng chờ (khai lúc tạo loại mới) chưa có id và mấy trường tên do backend tính.
 */
export function countText(rule: Pick<DocTypeLinkRule, 'min_count' | 'max_count'>): string {
