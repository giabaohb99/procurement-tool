...
function resolveRange(key: DateRangeKey) {
...
describe('DATE_RANGES', () => {
  it('"Hôm nay" trả về đúng ngày địa phương, không lệch sang ngày UTC', () => {
    ...
    expect(resolveRange('today')).toEqual({ from: '2026-08-18', to: '2026-08-18' })
  })
  ...
  it('"7 ngày qua" tính đủ 7 ngày kể cả hôm nay', () => {
    ...
    expect(resolveRange('week')).toEqual({ from: '2026-08-12', to: '2026-08-18' })
  })
  ...
  it('"Năm nay" bắt đầu từ 1/1, không phải 12 tháng gần nhất', () => {
    ...
    expect(resolveRange('year')).toEqual({ from: '2026-01-01', to: '2026-08-18' })
  })
  ...
  it('lùi qua mốc đầu tháng vẫn ra đúng tháng trước', () => {
    ...
    expect(resolveRange('week').from).toBe('2026-02-24')
  })
})
