              ...
              <LineField label="Nhân sự phụ trách">
                {canAssignNstm ? (
                  ...
                  <SearchSelect
                    ...
                    onChange={(assignee) => {
                      //  Chọn lại đúng người đang gán thì thôi — Radix Select cũ không bắn
                      //  sự kiện, mà `onAssigneeChange` là một lần gọi API phân công.
                      if (assignee === (draft.assignee || '')) return
                      patch({ assignee })
