...
function importOrder(): PurchaseOrderPrintData {
  return {
    ...
    import_costs: [
      {
        ...
        currency: 'USD',
        // bao-CR-453: dùng estimate_amount thay amount; effective_base = base_amount
        estimate_amount: 100,
        estimate_rate: 25000,
        effective_stage: 1,
        vat: 0,
    ...
    // bao-CR-453: allocation nay là dict theo giai đoạn; bản in đọc khóa "effective".
