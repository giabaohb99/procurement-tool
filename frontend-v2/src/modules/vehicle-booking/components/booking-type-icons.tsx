...
interface IconProps {
  className?: string
  /** Cho nơi gọi tô màu bằng giá trị động (palette hex, vd màu trạng thái lịch). */
  style?: CSSProperties
}
...
export function CarBookingIcon({ className, style }: IconProps) {
  return (
    <svg
      style={style}
      viewBox="0 0 39 28"
...
export function DeliveryBookingIcon({ className, style }: IconProps) {
  return (
    <svg
      style={style}
      viewBox="0 0 24 24"
