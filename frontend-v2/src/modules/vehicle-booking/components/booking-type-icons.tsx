/**
 * Hai dấu hiệu riêng cho hai loại yêu cầu — do khách chỉ định hình cụ thể nên vẽ
 * tay (lucide không có đúng dáng xe này). Nhận `currentColor` để đổi màu theo chữ,
 * kích thước bằng Tailwind ở nơi dùng (`className="size-6"`).
 */
interface IconProps {
  className?: string
}

/** Xe con — đặt xe công tác (chở người). viewBox 0 0 39 28. */
