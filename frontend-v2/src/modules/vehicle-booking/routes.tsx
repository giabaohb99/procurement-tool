...
const CustomCarIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 -6.75 38.2 38.2" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" {...props}>
