...
describe('DateTimePicker', () => {
  ...
  it('gõ vào cụm nào chỉ đổi cụm đó, không đụng cụm khác', () => {
    render(<DateTimePicker value="2026-09-08T16:30" onChange={() => {}} />)
  ...
  it('cảnh báo khi giờ vượt 23 và phút vượt 59', () => {
    const { rerender } = render(<DateTimePicker value="" onChange={() => {}} />)
    typeSeg('Giờ', '25')
    expect(screen.getByText(/Giờ 0–23/)).toBeInTheDocument()
    rerender(<DateTimePicker value="" onChange={() => {}} />)
    typeSeg('Phút', '60')
  ...
  it('cảnh báo khi sớm hơn min (chặn quá khứ)', () => {
    render(<DateTimePicker value="" min="2026-09-10T08:00" onChange={() => {}} />)
