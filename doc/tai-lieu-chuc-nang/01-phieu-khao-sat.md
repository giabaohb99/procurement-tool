...
6. Đính kèm: mỗi dòng đính kèm file (PDF/ảnh/Excel/Word/CDR, tối đa 20MB/file), lưu trên Cloudflare R2. Phiếu cũng có đính kèm ở cấp toàn phiếu (riêng với đính kèm theo dòng).
