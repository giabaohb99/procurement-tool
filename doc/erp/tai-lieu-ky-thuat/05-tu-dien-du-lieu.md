...
Bản 1.0 — 28/08/2026, cập nhật 03/09/2026 (F13a thêm `tab_forum_board`), 22/09/2026 (bao-CR-453 thêm `tab_po_cost`, `tab_po_cost_type`). Từ điển đang tả **104 bảng**.
...
|---|---|---|
| [05a-du-lieu-thu-mua.md](05a-du-lieu-thu-mua.md) | Chứng từ Thu mua (16 bảng) | YCBG + phương án, khảo sát, YCMH, ĐMH + dòng, nhận hàng, lịch sử mua, chi phí thu mua + danh mục loại chi phí |
...
Cộng đúng **16 + 14 + 21 + 30 + 23 = 104 bảng** — mỗi bảng đã tả có đúng một mục. Thêm bảng mới
