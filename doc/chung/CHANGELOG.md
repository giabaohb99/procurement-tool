...
### 2026-08-11
- **Bổ sung "Xuất xứ / TSKT / chất liệu" cho các dòng hàng cũ** (CR-061): sau khi phòng TM nạp lại **Thông số kỹ thuật** trên danh mục **Sản phẩm**, phần *Xuất xứ / TSKT / chất liệu* ở **Chi tiết dòng** của Đơn mua hàng **không tự cập nhật theo** — vì thông tin đó được sao xuống dòng hàng **ngay lúc lập đơn**, đơn lập trước khi sản phẩm có thông số thì ô đó rỗng vĩnh viễn. Đã điền bù: **13 dòng đơn mua hàng + 4 dòng lịch sử mua hàng** trên bản chính thức (bản thử nghiệm 3 + 2). **Chỉ điền vào ô đang để trống** — dòng nào đã gõ tay thì giữ nguyên, không có nội dung nào bị ghi đè hay xóa mất. Các lần mua **nhập từ file cũ** (nhãn *Dữ liệu cũ*) **không đụng tới**: đó là ảnh chụp của lần mua nhiều năm trước, điền thông số hôm nay vào là sai thực tế. Từ nay đơn lập mới vẫn tự lấy thông số của sản phẩm như cũ.
- **Sửa lỗi: người không có quyền xem Nhà cung cấp vẫn thấy NCC trong popup "Lịch sử mua hàng gần nhất"** (CR-060): popup mở từ nút cạnh mã hàng ở **Yêu cầu mua hàng** trước đây hiện đủ **tên nhà cung cấp** cho cả người yêu cầu — trong khi các màn khác đã che. Nay ai **không có quyền xem NCC** thì cột đó **không hiện**, và ô tìm kiếm cũng **không tìm theo tên NCC** nữa (nếu vẫn tìm được thì chỉ cần gõ tên một NCC là đoán ra được ai đang bán mã hàng đó). Phần **giá, số lượng, ngày đặt, mã PO, công ty vẫn xem bình thường** để tham chiếu giá cũ. Người **có quyền xem NCC** không thấy gì khác trước. Áp dụng cả ở tab *Lịch sử mua hàng* trong chi tiết Sản phẩm.
- **Đính kèm ảnh đối chiếu cho dòng ngay khi chưa lưu phiếu** (CR-060): ở **Yêu cầu mua hàng**, popup *Chi tiết dòng* trước đây báo "Lưu phiếu trước để đính kèm ảnh đối chiếu cho dòng" — phải lưu xong, mở lại dòng, rồi mới chọn được ảnh. Nay **chọn ảnh được ngay**: ảnh hiện lên xem trước kèm ghi chú *"đang chờ — sẽ được tải lên khi bấm Lưu phiếu"*, xóa và kéo-thả sắp thứ tự vẫn dùng như thường, và ảnh **tự tải lên đúng dòng** ngay sau khi bấm Lưu (hoặc Xong). Áp dụng cho **cả phiếu mới lẫn dòng mới thêm vào phiếu đã có**. Lưu ý: **thoát ra khi chưa bấm Lưu là mất ảnh đã chọn**, vì lúc đó ảnh chưa nằm trên máy chủ. Khu *Chứng từ & Tài liệu đính kèm* của cả phiếu **vẫn giữ nguyên** yêu cầu lưu phiếu trước.

### 2026-08-10
- **Ô VAT giờ nhập được mọi thuế suất, chặn dưới 100%** (CR-058): trước đây VAT theo dòng là **danh sách chọn cố định** — Phiếu khảo sát chỉ có 0/2/4/6/8/10%, Yêu cầu mua hàng chỉ có 0/5/8/10% — nên thuế suất khác (vd 3,5%) không nhập được, phải ghi vào ô Ghi chú rồi tính tay. Nay là **ô nhập số**: gõ thẳng con số, cho tới 2 số lẻ, và bị chặn **dưới 100%** (gõ quá thì ô tự kéo về 99,99). Áp dụng cho **Phiếu khảo sát** (bảng phương án + popup chi tiết dòng), **Yêu cầu mua hàng** (bảng dòng hàng + popup sửa dòng) và **Đơn mua hàng** (Chi tiết dòng — vốn đã nhập số nhưng chưa có chặn trên). Kèm theo: chọn giá từ popup **Lịch sử mua hàng** nay điền **đúng VAT của lần mua trước** — trước đây VAT nào không nằm trong danh sách thì bị bỏ qua âm thầm. Ô **VAT mặc định của Nhà cung cấp** cũng siết xuống dưới 100% và chặn cả khi nhập từ file CSV. **Số liệu đã lưu không đổi**, phiếu cũ mở lên vẫn nguyên.
- **Sửa lỗi: tạo Yêu cầu mua hàng từ Yêu cầu báo giá bị mất VAT** (CR-058): khi bấm **Tạo YCMH** ở Yêu cầu báo giá, dòng hàng sinh ra luôn nhận **VAT = 0%** dù phương án đã chọn có NCC báo giá 8% hay 10%, và cột **Thành tiền** cũng thiếu phần thuế. Người lập phải sửa tay từng dòng; quên là **Đơn mua hàng tạo tiếp từ đó cũng sai tiền**. Nay VAT của phương án được mang thẳng sang và thành tiền tính gồm VAT như khi lập tay. Kiểm trên dữ liệu bản thử nghiệm: **20 dòng** đã sinh ra theo lối cũ bị 8% → 0%. **Phiếu cũ không bị sửa tự động** — YCMH nào tạo từ Yêu cầu báo giá trước bản này, nếu chưa chỉnh tay thì phòng TM kiểm lại cột VAT trước khi tạo Đơn mua hàng. Hai chặng còn lại đã kiểm và **không có lỗi**: Phiếu khảo sát → phương án, và YCMH → Đơn mua hàng (kể cả nút Nhân bản đơn).
