...
### 2026-08-08
- **Lịch sử mua hàng: nhãn "Dữ liệu cũ" và dọn dòng trùng** (CR-055): cột **Mã PO** của các lần mua nhập từ file cũ đổi từ chữ *"Dữ liệu cũ"* sang nhãn **"Trước hệ thống"** có chú thích khi rê chuột — trước đây nhìn cứ như thiếu dữ liệu nên hay bị báo lỗi, thực tế những lần mua đó diễn ra **trước khi dùng hệ thống** nên không hề có đơn mua hàng để mở. Rà trên dev: 6.418 dòng dữ liệu cũ thì **6.345 dòng không có đơn nào tương ứng** — đúng bản chất, không phải lỗi. Riêng **61 dòng bị đếm 2 lần** (1 dòng nhập từ file + 1 dòng hệ thống tự chốt cho cùng một lần mua) làm bảng lịch sử hiện 2 dòng giống nhau, tham chiếu giá đọc ra sai — thêm công cụ dọn các dòng trùng đó (giữ bản của hệ thống, bỏ bản nhập tay).
