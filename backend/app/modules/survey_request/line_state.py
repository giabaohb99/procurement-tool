...
"""
from .model import LS_COMPLETED, LS_RESURVEY, SurveyRequestLine
...
STATES = [STATE_NOT_RECEIVED, STATE_RECEIVED, STATE_SURVEYING, STATE_ANSWERED,
          STATE_NO_OPTION, STATE_CHOSEN, STATE_RESURVEY, STATE_PR_CREATED, STATE_DONE]
...
STATE_TONE = {
    ...
    STATE_RESURVEY: "err", STATE_PR_CREATED: "info", STATE_DONE: "ok",
}
